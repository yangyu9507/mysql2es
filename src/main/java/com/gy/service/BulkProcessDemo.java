...
//            ps = conn.prepareStatement(sql, ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY);
            ...
            log.info("Get result from {} success. " , tableName);
            ...
            log.info("-------------------------- Finally insert Index[{}]number total : {}",index,count);
            ...
            try {
                ...
                log.error("Closing PreparedStatement or ResultSet Failed:",ex);
            }
        }
    }
     ...
     * @throws SQLException
     */
    private void getColumnType(ResultSet rs, String c,String column,int columnType,HashMap<String,Object> map){
        try {
            switch (columnType) {
                case Types.BIGINT:
            ...
            String res = String.format("Get Result From Mysql Failed ,ResultSet[%s]," +
                    "c[%s], column[%s],columnType[%s],map[%s]", JSONObject.toJSONString(rs),c,column,String.valueOf(columnType)
